...
if (isServer) then {
	...
	//--- Paratroopers.
	['WFBE_EASTPARACHUTELEVEL1',['RU_Soldier_SL','RU_Soldier_Medic','RU_Soldier_MG','RU_Soldier_AR','RU_Soldier_AT','RU_Soldier_Marksman'],true] Call SetNamespace;
	['WFBE_EASTPARACHUTELEVEL2',['RU_Soldier_SL','RU_Soldier_Medic','RU_Soldier_MG','RU_Soldier_AR','RU_Soldier_AT','RU_Soldier_Marksman','RU_Soldier','RU_Soldier_AT','RU_Soldier_AT'],true] Call SetNamespace;
	['WFBE_EASTPARACHUTELEVEL3',['RU_Soldier_SL','RU_Soldier_Medic','RU_Soldier_MG','RU_Soldier_AR','RU_Soldier_AT','RU_Soldier_Marksman','RU_Soldier','RU_Soldier_AT','RU_Soldier_AT','RU_Soldier_AT','RU_Soldier_AT','RU_Soldier_AT'],true] Call SetNamespace;
