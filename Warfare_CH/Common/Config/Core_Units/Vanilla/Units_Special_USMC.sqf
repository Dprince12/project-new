...
if (isServer) then {
	...
	//--- Paratroopers.
	['WFBE_WESTPARACHUTELEVEL1',['USMC_Soldier_SL','USMC_Soldier_Medic','USMC_Soldier_MG','USMC_SoldierS_Engineer','USMC_Soldier_AT','USMC_SoldierM_Marksman'],true] Call SetNamespace;
	['WFBE_WESTPARACHUTELEVEL2',['USMC_Soldier_SL','USMC_Soldier_Medic','USMC_Soldier_MG','USMC_SoldierS_Engineer','USMC_Soldier_AT','USMC_SoldierM_Marksman','USMC_Soldier','USMC_Soldier','USMC_Soldier'],true] Call SetNamespace;
	['WFBE_WESTPARACHUTELEVEL3',['USMC_Soldier_SL','USMC_Soldier_Medic','USMC_Soldier_MG','USMC_SoldierS_Engineer','USMC_Soldier_AT','USMC_SoldierM_Marksman','USMC_Soldier','USMC_Soldier','USMC_Soldier','USMC_Soldier','USMC_Soldier','USMC_Soldier','USMC_Soldier'],true] Call SetNamespace;
